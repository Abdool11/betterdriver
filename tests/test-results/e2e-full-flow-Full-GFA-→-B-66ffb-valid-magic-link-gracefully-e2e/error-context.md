...
```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3002/join/e2e-invalid-token-1779615220141
Call log:
  - navigating to "http://localhost:3002/join/e2e-invalid-token-1779615220141", waiting until "load"
