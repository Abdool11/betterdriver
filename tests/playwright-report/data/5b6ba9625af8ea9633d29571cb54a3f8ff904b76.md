...
- Name: e2e\full-flow.spec.ts >> Full GFA → BD driver activation flow >> Step 8 — BD admin dashboard accessible
- Location: e2e\full-flow.spec.ts:131:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3002/admin/login
Call log:
  - navigating to "http://localhost:3002/admin/login", waiting until "load"
