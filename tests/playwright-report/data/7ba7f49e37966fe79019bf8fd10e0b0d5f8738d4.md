...
- Name: e2e\full-flow.spec.ts >> Full GFA → BD driver activation flow >> Step 6 — BD handles invalid magic link gracefully
- Location: e2e\full-flow.spec.ts:112:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3002/join/e2e-invalid-token-1779615225377
Call log:
  - navigating to "http://localhost:3002/join/e2e-invalid-token-1779615225377", waiting until "load"
