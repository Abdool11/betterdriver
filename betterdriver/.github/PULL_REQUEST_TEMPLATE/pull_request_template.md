...
<!-- Explain the driver, client or operational outcome in two or three sentences. -->
...
| External configuration required? | `No` / `Yes — Meta, Moodle, Vercel, cron or other:` |
...
| Driver communications affected? | `No` / `Yes — WhatsApp template, email, notification or copy:` |
